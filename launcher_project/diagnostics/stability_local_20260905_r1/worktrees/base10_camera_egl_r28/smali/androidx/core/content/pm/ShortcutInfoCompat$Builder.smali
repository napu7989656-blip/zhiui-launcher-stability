...
.method public constructor <init>(Landroid/content/Context;Landroid/content/pm/ShortcutInfo;)V
    ...
    invoke-static {p2}, Lo/w2;->ͽ(Landroid/content/pm/ShortcutInfo;)Ljava/lang/String;

    move-result-object p1

    iput-object p1, v0, Landroidx/core/content/pm/ShortcutInfoCompat;->mId:Ljava/lang/String;

    invoke-static {p2}, Lo/w2;->Ζ(Landroid/content/pm/ShortcutInfo;)Ljava/lang/String;

    move-result-object p1

    iput-object p1, v0, Landroidx/core/content/pm/ShortcutInfoCompat;->mPackageName:Ljava/lang/String;

    invoke-static {p2}, Lo/w2;->Γ(Landroid/content/pm/ShortcutInfo;)[Landroid/content/Intent;
    ...
    invoke-static {p2}, Lo/w2;->Ͱ(Landroid/content/pm/ShortcutInfo;)Landroid/content/ComponentName;

    move-result-object p1

    iput-object p1, v0, Landroidx/core/content/pm/ShortcutInfoCompat;->mActivity:Landroid/content/ComponentName;

    invoke-static {p2}, Lo/w2;->ͼ(Landroid/content/pm/ShortcutInfo;)Ljava/lang/CharSequence;

    move-result-object p1

    iput-object p1, v0, Landroidx/core/content/pm/ShortcutInfoCompat;->mLabel:Ljava/lang/CharSequence;

    invoke-static {p2}, Lo/w2;->Ε(Landroid/content/pm/ShortcutInfo;)Ljava/lang/CharSequence;

    move-result-object p1

    iput-object p1, v0, Landroidx/core/content/pm/ShortcutInfoCompat;->mLongLabel:Ljava/lang/CharSequence;

    invoke-static {p2}, Lo/w2;->Ι(Landroid/content/pm/ShortcutInfo;)Ljava/lang/CharSequence;
    ...
    invoke-static {p2}, Lo/qd;->ˋ(Landroid/content/pm/ShortcutInfo;)I
    ...
    :cond_0
    invoke-static {p2}, Lo/hh;->Ώ(Landroid/content/pm/ShortcutInfo;)Z
    ...
    :goto_1
    invoke-static {p2}, Lo/w2;->Ά(Landroid/content/pm/ShortcutInfo;)Ljava/util/Set;

    move-result-object v1

    iput-object v1, v0, Landroidx/core/content/pm/ShortcutInfoCompat;->mCategories:Ljava/util/Set;

    invoke-static {p2}, Lo/w2;->ͷ(Landroid/content/pm/ShortcutInfo;)Landroid/os/PersistableBundle;
    ...
    invoke-static {p2}, Lo/w2;->ͺ(Landroid/content/pm/ShortcutInfo;)Landroid/os/UserHandle;

    move-result-object v1

    iput-object v1, v0, Landroidx/core/content/pm/ShortcutInfoCompat;->mUser:Landroid/os/UserHandle;

    invoke-static {p2}, Lo/w2;->ˏ(Landroid/content/pm/ShortcutInfo;)J
    ...
    invoke-static {p2}, Lo/Κ;->Γ(Landroid/content/pm/ShortcutInfo;)Z
    ...
    invoke-static {p2}, Lo/hh;->Α(Landroid/content/pm/ShortcutInfo;)Z
    ...
    invoke-static {p2}, Lo/w2;->ˋ(Landroid/content/pm/ShortcutInfo;)I

...
.method public static addDynamicShortcuts(Landroid/content/Context;Ljava/util/List;)Z
    ...
    :cond_1
    invoke-static {}, Lo/hh;->Ͱ()Ljava/lang/Class;
    ...
    invoke-static {v3}, Lo/hh;->ˏ(Ljava/lang/Object;)Landroid/content/pm/ShortcutManager;

    move-result-object v3

    invoke-static {v3, v2}, Lo/hh;->Ί(Landroid/content/pm/ShortcutManager;Ljava/util/ArrayList;)Z
...
.method public static createShortcutResultIntent(Landroid/content/Context;Landroidx/core/content/pm/ShortcutInfoCompat;)Landroid/content/Intent;
    ...
    invoke-static {p0}, Lo/hh;->ˏ(Ljava/lang/Object;)Landroid/content/pm/ShortcutManager;
    ...
    invoke-static {p0, v0}, Lo/zd;->ˏ(Landroid/content/pm/ShortcutManager;Landroid/content/pm/ShortcutInfo;)Landroid/content/Intent;
...
.method public static disableShortcuts(Landroid/content/Context;Ljava/util/List;Ljava/lang/CharSequence;)V
    ...
    invoke-static {v0}, Lo/hh;->ˏ(Ljava/lang/Object;)Landroid/content/pm/ShortcutManager;

    move-result-object v0

    invoke-static {v0, p1, p2}, Lo/hh;->ͷ(Landroid/content/pm/ShortcutManager;Ljava/util/List;Ljava/lang/CharSequence;)V
...
.method public static enableShortcuts(Landroid/content/Context;Ljava/util/List;)V
    ...
    invoke-static {v2}, Lo/hh;->ˏ(Ljava/lang/Object;)Landroid/content/pm/ShortcutManager;

    move-result-object v2

    invoke-static {v2, v1}, Lo/hh;->ʹ(Landroid/content/pm/ShortcutManager;Ljava/util/ArrayList;)V
...
.method public static getDynamicShortcuts(Landroid/content/Context;)Ljava/util/List;
    ...
    invoke-static {v0}, Lo/hh;->Ύ(Landroid/content/pm/ShortcutManager;)Ljava/util/List;
    ...
    invoke-static {v2}, Lo/w2;->Ͷ(Ljava/lang/Object;)Landroid/content/pm/ShortcutInfo;
...
.method public static getIconMaxHeight(Landroid/content/Context;)I
    ...
    invoke-static {p0}, Lo/hh;->ˋ(Landroid/content/pm/ShortcutManager;)I
...
.method public static getIconMaxWidth(Landroid/content/Context;)I
    ...
    invoke-static {p0}, Lo/hh;->Ό(Landroid/content/pm/ShortcutManager;)I
...
.method public static getMaxShortcutCountPerActivity(Landroid/content/Context;)I
    ...
    invoke-static {p0}, Lo/hh;->ͽ(Landroid/content/pm/ShortcutManager;)I
...
.method public static getShortcuts(Landroid/content/Context;I)Ljava/util/List;
    ...
    invoke-static {v0, p1}, Lo/Κ;->ͻ(Landroid/content/pm/ShortcutManager;I)Ljava/util/List;
    ...
    invoke-static {v0}, Lo/hh;->ͱ(Landroid/content/pm/ShortcutManager;)Ljava/util/List;
    ...
    invoke-static {v0}, Lo/hh;->Ά(Landroid/content/pm/ShortcutManager;)Ljava/util/List;
...
.method public static isRateLimitingActive(Landroid/content/Context;)Z
    ...
    invoke-static {p0}, Lo/hh;->ͻ(Landroid/content/pm/ShortcutManager;)Z
...
.method public static isRequestPinShortcutSupported(Landroid/content/Context;)Z
    ...
    invoke-static {p0}, Lo/zd;->ʹ(Landroid/content/pm/ShortcutManager;)Z
...
.method public static pushDynamicShortcut(Landroid/content/Context;Landroidx/core/content/pm/ShortcutInfoCompat;)Z
    ...
    invoke-static {v0, v4}, Lo/Κ;->ͽ(Landroid/content/pm/ShortcutManager;Landroid/content/pm/ShortcutInfo;)V
    ...
    invoke-static {v0}, Lo/hh;->ͻ(Landroid/content/pm/ShortcutManager;)Z
    ...
    invoke-static {v0, v4}, Lo/hh;->Ͷ(Landroid/content/pm/ShortcutManager;Ljava/util/List;)V
    ...
    invoke-static {v0, v4}, Lo/hh;->Έ(Landroid/content/pm/ShortcutManager;Ljava/util/List;)V
...
.method public static removeAllDynamicShortcuts(Landroid/content/Context;)V
    ...
    invoke-static {v0}, Lo/hh;->Ͳ(Landroid/content/pm/ShortcutManager;)V
...
.method public static removeDynamicShortcuts(Landroid/content/Context;Ljava/util/List;)V
    ...
    invoke-static {v0, p1}, Lo/hh;->Ͷ(Landroid/content/pm/ShortcutManager;Ljava/util/List;)V
...
.method public static removeLongLivedShortcuts(Landroid/content/Context;Ljava/util/List;)V
    ...
    invoke-static {v0, p1}, Lo/Κ;->Ά(Landroid/content/pm/ShortcutManager;Ljava/util/List;)V
...
.method public static reportShortcutUsed(Landroid/content/Context;Ljava/lang/String;)V
    ...
    invoke-static {v0, p1}, Lo/hh;->ͳ(Landroid/content/pm/ShortcutManager;Ljava/lang/String;)V
...
.method public static requestPinShortcut(Landroid/content/Context;Landroidx/core/content/pm/ShortcutInfoCompat;Landroid/content/IntentSender;)Z
    ...
    invoke-static {p0, p1, p2}, Lo/zd;->Ͷ(Landroid/content/pm/ShortcutManager;Landroid/content/pm/ShortcutInfo;Landroid/content/IntentSender;)Z
...
.method public static setDynamicShortcuts(Landroid/content/Context;Ljava/util/List;)Z
    ...
    invoke-static {v3, v2}, Lo/hh;->ͼ(Landroid/content/pm/ShortcutManager;Ljava/util/ArrayList;)Z
...
.method public static updateShortcuts(Landroid/content/Context;Ljava/util/List;)Z
    ...
    invoke-static {v3, v2}, Lo/hh;->ΐ(Landroid/content/pm/ShortcutManager;Ljava/util/ArrayList;)Z

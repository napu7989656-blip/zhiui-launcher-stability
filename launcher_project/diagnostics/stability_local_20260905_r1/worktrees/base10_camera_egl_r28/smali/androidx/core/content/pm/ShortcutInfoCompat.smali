...
.method public static fromShortcuts(Landroid/content/Context;Ljava/util/List;)Ljava/util/List;
    ...
    invoke-static {v1}, Lo/w2;->Ͷ(Ljava/lang/Object;)Landroid/content/pm/ShortcutInfo;
...
.method public static getLocusId(Landroid/content/pm/ShortcutInfo;)Landroidx/core/content/LocusIdCompat;
    ...
    invoke-static {p0}, Lo/v7;->ͳ(Landroid/content/pm/ShortcutInfo;)Landroid/content/LocusId;
    ...
    :cond_1
    invoke-static {p0}, Lo/w2;->ͷ(Landroid/content/pm/ShortcutInfo;)Landroid/os/PersistableBundle;
...
.method public toShortcutInfo()Landroid/content/pm/ShortcutInfo;
    ...
    invoke-static {}, Lo/w2;->Έ()V

    iget-object v0, p0, Landroidx/core/content/pm/ShortcutInfoCompat;->mContext:Landroid/content/Context;

    iget-object v1, p0, Landroidx/core/content/pm/ShortcutInfoCompat;->mId:Ljava/lang/String;

    invoke-static {v0, v1}, Lo/w2;->ͱ(Landroid/content/Context;Ljava/lang/String;)Landroid/content/pm/ShortcutInfo$Builder;

    move-result-object v0

    iget-object v1, p0, Landroidx/core/content/pm/ShortcutInfoCompat;->mLabel:Ljava/lang/CharSequence;

    invoke-static {v0, v1}, Lo/w2;->Ͳ(Landroid/content/pm/ShortcutInfo$Builder;Ljava/lang/CharSequence;)Landroid/content/pm/ShortcutInfo$Builder;

    move-result-object v0

    iget-object v1, p0, Landroidx/core/content/pm/ShortcutInfoCompat;->mIntents:[Landroid/content/Intent;

    invoke-static {v0, v1}, Lo/w2;->ͳ(Landroid/content/pm/ShortcutInfo$Builder;[Landroid/content/Intent;)Landroid/content/pm/ShortcutInfo$Builder;
    ...
    invoke-static {v0, v1}, Lo/w2;->Ό(Landroid/content/pm/ShortcutInfo$Builder;Landroid/graphics/drawable/Icon;)V
    ...
    invoke-static {v0, v1}, Lo/w2;->Ώ(Landroid/content/pm/ShortcutInfo$Builder;Ljava/lang/CharSequence;)V
    ...
    invoke-static {v0, v1}, Lo/w2;->Η(Landroid/content/pm/ShortcutInfo$Builder;Ljava/lang/CharSequence;)V
    ...
    invoke-static {v0, v1}, Lo/w2;->Ί(Landroid/content/pm/ShortcutInfo$Builder;Landroid/content/ComponentName;)V
    ...
    invoke-static {v0, v1}, Lo/w2;->ΐ(Landroid/content/pm/ShortcutInfo$Builder;Ljava/util/Set;)V

    :cond_4
    iget v1, p0, Landroidx/core/content/pm/ShortcutInfoCompat;->mRank:I

    invoke-static {v0, v1}, Lo/w2;->Ή(Landroid/content/pm/ShortcutInfo$Builder;I)V

    iget-object v1, p0, Landroidx/core/content/pm/ShortcutInfoCompat;->mExtras:Landroid/os/PersistableBundle;

    if-eqz v1, :cond_5

    invoke-static {v0, v1}, Lo/w2;->Ύ(Landroid/content/pm/ShortcutInfo$Builder;Landroid/os/PersistableBundle;)V
    ...
    :cond_6
    invoke-static {v0, v2}, Lo/v7;->ͽ(Landroid/content/pm/ShortcutInfo$Builder;[Landroid/app/Person;)V
    ...
    invoke-static {v0, v1}, Lo/v7;->ͻ(Landroid/content/pm/ShortcutInfo$Builder;Landroid/content/LocusId;)V

    :cond_8
    iget-boolean v1, p0, Landroidx/core/content/pm/ShortcutInfoCompat;->mIsLongLived:Z

    invoke-static {v0, v1}, Lo/v7;->ͼ(Landroid/content/pm/ShortcutInfo$Builder;Z)V
    ...
    :cond_a
    invoke-static {v0}, Lo/w2;->ʹ(Landroid/content/pm/ShortcutInfo$Builder;)Landroid/content/pm/ShortcutInfo;

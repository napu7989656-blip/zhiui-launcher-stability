...
'''
(OUT/'影像资源归属依赖审计_20260913.md').write_text(note,encoding='utf-8')
with paths[0].open('a',encoding='utf-8') as p:p.write('\n\n## 72. 影像清理与显示位图归属依赖\n\n'+note)
for p in paths[1:]:p.write_text(note+'\n\n---\n\n'+p.read_text(encoding='utf-8'),encoding='utf-8')
print('R25 retained; conditional ownership evidence recorded; next camera work order refined.')
